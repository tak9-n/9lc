             ...
             (if (eq (9lc.parser:node-kind node) '9lc.parser:ND_NUM)
                 ...
                 (progn
                   ...
                   (push (case (9lc.parser:node-kind node)
                           ...
                           ((9lc.parser:ND_EQUAL 9lc.parser:ND_NOT_EQUAL 9lc.parser:ND_BIGGER 9lc.parser:ND_EQ_BIGGER)
                            (format nil "  cmp rax, rdi~%  ~a~%  movzb rax,al~%"
                                    (case (9lc.parser:node-kind node)
                                      ((9lc.parser:ND_EQUAL) "sete al")
                                      ((9lc.parser:ND_NOT_EQUAL) "setne al")
                                      ((9lc.parser:ND_BIGGER) "setl al")
                                      ((9lc.parser:ND_EQ_BIGGER) "setle al")))))
                         asm-lst)
